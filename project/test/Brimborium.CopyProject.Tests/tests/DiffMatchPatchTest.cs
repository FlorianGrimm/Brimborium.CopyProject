...
public class diff_match_patchTest : DiffMatchPatcher {
    ...
    private void diff_commonSuffixTest() {
        // Detect any common suffix.
    ...
    private void diff_commonOverlapTest() {
    ...
    private void diff_halfmatchTest() {
        this.Diff_Timeout = 1;
    ...
    private void diff_linesToCharsTest() {
    ...
    private void diff_cleanupMergeTest() {
    ...
    private void diff_cleanupSemanticTest() {
    ...
    private void diff_cleanupEfficiencyTest() {
    ...
    private void diff_prettyHtmlTest() {
        // Pretty print.
        List<Diff> diffs = new List<Diff> {
        new Diff(Operation.EQUAL, "a\n"),
    ...
    private void diff_levenshteinTest() {
        List<Diff> diffs = new List<Diff> {
        new Diff(Operation.DELETE, "abc"),
        new Diff(Operation.INSERT, "1234"),
        new Diff(Operation.EQUAL, "xyz")};
    ...
    private void match_alphabetTest() {
    ...
    private void patch_patchObjTest() {
        // Patch Object.
        Patch p = new Patch();
        p.Start1 = 20;
        p.Start2 = 21;
    ...
    private void patch_fromTextTest() {
    ...
    private void patch_addContextTest() {
        this.Patch_Margin = 4;
        Patch p;
    ...
    private void patch_splitMaxTest() {
    ...
    private void patch_addPaddingTest() {
        List<Patch> patches;
